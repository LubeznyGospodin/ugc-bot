...
⚠️ Свежие посты (с середины 2026) отдают видео только по клику в клиенте —
в HTML превью ссылок нет. Такие ролики сюда не попадут: их придётся выгружать
руками или через Telethon с пользовательской сессией.
"""
...
SHARE = {"lifestyle": 0.40, "walk": 0.22, "review": 0.18, "wow": 0.15, "r360": 0.05}
