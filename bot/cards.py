...
_MALE_FIRST = {
    ...
    # На -ь: окончание само по себе неинформативно (Игорь м / Любовь ж), поэтому
    # ходовые имена перечисляем явно — иначе уходят в «пол неизвестен».
    "игорь", "олесь", "виль", "рафаэль", "камиль", "даниэль", "габриэль",
}
...
_FEMALE_FIRST = {
    ...
    "любовь", "нинель", "рахиль", "эсфирь", "ассоль", "нинэль",
}
